...
| `data.prompt_type` | `"global"` | `"global"` | Prompt type used by the released VLA data pipeline. Subtask prompts are not currently consumed; unsupported values fail during argument parsing or dataset construction. |
